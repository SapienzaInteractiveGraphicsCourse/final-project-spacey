...
let bonesOffset = [];
let actualBones = [];
let startingPosition = new BABYLON.Vector3(-10, -22, -10);
let targetPosition = new BABYLON.Vector3(20, -22, 150);
let farCameraPosition = new BABYLON.Vector3(0, 50, 0);
let farCamera;
let nearCamera;
let ground;
let boy;
...
let txt = "MISSION 1: Hurry up! Your partner needs you, oxigen is running out!";
...
let createScene = function () {
    ...
    earth.material.diffuseTexture = new BABYLON.Texture("../images/earth.jpg", scene);
...
function showGUI() {
    ...
    mapImage = new BABYLON.GUI.Image("", "../images/heightmap.png");
    mapImage.width = 1.1;
    mapImage.height = 1.1;
    mapImage.alpha = 0.5;
